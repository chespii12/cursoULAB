var miFormulario:HTMLFormElement; //para que sepa que el fichero es un html

function addParrafo()
{
	let parr = <HTMLInputElement>document.getElementsByName("numero")[0];
	let numNewP = +(parr.value)+1;
	...
	let title = <HTMLElement>document.getElementsByName("titulo")[0].value;
	let newBtn = <HTMLInputElement>document.getElementById("boton");
